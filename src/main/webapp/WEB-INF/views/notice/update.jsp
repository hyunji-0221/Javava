...
<%@ include file="/resources/admin/in/sidebar.jsp"%>
    ...
    <form action="/notice/update" method="POST">
        <input type="hidden" id="bno" name="bno" value="${nread.bno }"><br><br>
        <label for="title">제목:</label><br>
        <input type="text" id="title" name="title" value="${nread.title }" required><br><br>

        <label for="content">내용:</label><br>
        <textarea id="content" name="content" rows="4" cols="50" required>${ nread.content }</textarea><br><br>
