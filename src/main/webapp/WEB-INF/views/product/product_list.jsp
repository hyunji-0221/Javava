        ...
        <div class="col-md-4">
          <div class="py-6 px-8 bg-neutral-0 rounded-4 box-shadow">
            ...
            <div class="d-flex align-items-center justify-content-between rounded-pill border border-neutral-40 bg-primary-3p px-5 py-3">
              <input type="text" class="form-control bg-transparent border-0 focus-outline-0" placeholder="검색어를 입력해주세요">
            ...
            <ul class="list list-row flex-wrap align-items-center gap-6">
              <li>
                <div class="d-flex align-items-center gap-2">
                  <input class="custom-radio custom-radio--primary-300" type="radio" name="property-type" id="search-all">
                  <label class="d-inline-block fs-18 fw-medium cursor-pointer" for="search-all"> 전체 </label>
                </div>
              </li>
              <li>
                <div class="d-flex align-items-center gap-2">
                  <input class="custom-radio custom-radio--primary-300" type="radio" name="property-type" id="search-hotel">
                  <label class="d-inline-block fs-18 fw-medium cursor-pointer" for="search-hotel"> 호텔/리조트 </label>
                </div>
              </li>
              <li>
                <div class="d-flex align-items-center gap-2">
                  <input class="custom-radio custom-radio--primary-300" type="radio" name="property-type" id="search-pension">
                  <label class="d-inline-block fs-18 fw-medium cursor-pointer" for="search-pension"> 펜션 </label>
                </div>
              </li>
              <li>
                <div class="d-flex align-items-center gap-2">
                  <input class="custom-radio custom-radio--primary-300" type="radio" name="property-type" id="search-fullvilla">
                  <label class="d-inline-block fs-18 fw-medium cursor-pointer" for="search-fullvilla"> 풀빌라 </label>
                </div>
              </li>
              <li>
                <div class="d-flex align-items-center gap-2">
                  <input class="custom-radio custom-radio--primary-300" type="radio" name="property-type" id="search-guesthouse">
                  <label class="d-inline-block fs-18 fw-medium cursor-pointer" for="search-guesthouse"> 게스트하우스 </label>
                </div>
              </li>
            </ul>
            <div class="hr-dashed my-6 opacity-50"></div>
              ...
              <li>
                <div class="property-search__select property-search__col rounded-pill px-6">
                  <select class="form-select" aria-label="Default select example">
                    ...
                    <option value="2">강원권</option>
                    <option value="3">제주도</option>
                    <option value="4">경상권</option>
                    <option value="5">전라권</option>
                    <option value="6">충청권</option>
                  </select>
                </div>
              </li>
            ...
            <div class="range-slider">
              ...
              <span class="range-min-wrapper">
                <input class="range-slider__input range-slider__min" type="range" min="1" max="100" value="25">
              </span>
              <span class="range-max-wrapper">
                <input class="range-slider__input range-slider__max" type="range" min="1" max="100" value="100">
              </span>
            </div>
            ...
            <a href="#" class="btn btn-outline-primary py-3 px-6 rounded-pill d-inline-flex align-items-center justify-content-center gap-2 fw-semibold w-100 text-center">
              <span class="material-symbols-outlined mat-icon fw-300"> search </span> 찾기 </a>
          </div>
        </div>
        <div class="col-md-8">
          <div class="row g-4">
              ...
              <div class="bg-neutral-0 rounded-2 py-3 px-6 box-shadow">
                <ul class="list list-row align-items-center flex-wrap gap-3">
                  <li class="d-none d-xl-block">
                    <p class="mb-0 clr-neutral-500">검색 결과: 20 </p>
                  </li>
